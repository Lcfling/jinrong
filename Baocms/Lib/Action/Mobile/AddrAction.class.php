...
class AddrAction extends CommonAction {
    ...
    public function update_addr(){
        ...
        if(!$addr_id){
            ...
            if($type == 1){
                $this->fengmiMsg('恭喜您，操作成功！',U('mobile/ele/pay',array('order_id'=>$order_id)));
            }elseif($type == 2){
                $this->fengmiMsg('恭喜您，操作成功！',U('mobile/mall/pay',array('order_id'=>$order_id)));
            }elseif($type == 3){
                $this->fengmiMsg('恭喜您，操作成功！',U('mobile/mart/pay',array('order_id'=>$order_id)));
            }else{
